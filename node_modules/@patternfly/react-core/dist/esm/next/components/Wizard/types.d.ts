...
export declare type WizardNavStepFunction = (currentStep: WizardNavStepData, previousStep: WizardNavStepData) => void | Promise<void>;
...
export declare type CustomWizardNavItemFunction = (step: WizardControlStep, activeStep: WizardControlStep, steps: WizardControlStep[], goToStepByIndex: (index: number) => void) => React.ReactElement<WizardNavItemProps>;
/** Callback for the Wizard's 'footer' property. Returns element which replaces the Wizard's default footer. */
export declare type CustomWizardFooterFunction = (activeStep: WizardControlStep, onNext: () => void | Promise<void>, onBack: () => void | Promise<void>, onClose: () => void | Promise<void>) => React.ReactElement<WizardFooterProps>;
