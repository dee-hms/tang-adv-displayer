...
const WizardFooterWrapper = ({ children }) => (react_1.default.createElement("footer", { className: react_styles_1.css(wizard_1.default.wizardFooter) }, children));
...
const WizardFooter = (_a) => {
    ...
    const activeStepFooter = !types_1.isCustomWizardFooter(activeStep.footer) && activeStep.footer;
