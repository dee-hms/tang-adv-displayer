...
const OverflowTab = (_a) => {
    ...
    const overflowTab = (react_1.default.createElement("li", Object.assign({ className: react_styles_1.css(tabs_1.default.tabsItem, 'pf-m-overflow', selectedTab && tabs_1.default.modifiers.current, className), role: "presentation", ref: overflowLIRef }, props),
        react_1.default.createElement("button", { type: "button", className: react_styles_1.css(tabs_1.default.tabsLink, isExpanded && tabs_1.default.modifiers.expanded), onClick: () => toggleMenu(), "aria-label": toggleAriaLabel, "aria-haspopup": "menu", "aria-expanded": isExpanded, role: "tab", ref: overflowTabRef },
