...
function useModule(scope, module, defaultState, options) {
    ...
    var _a = (0, react_1.useState)(defaultState), data = _a[0], setData = _a[1];
    var fetchModule = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var cachedModule, Module, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cachedModule = (0, core_1.getCachedModule)(scope, module, defaultOptions.skipCache);
