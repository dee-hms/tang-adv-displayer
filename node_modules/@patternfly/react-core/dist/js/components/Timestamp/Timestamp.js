...
const Timestamp = (_a) => {
    ...
    React.useEffect(() => {
        ...
        if (datetimeUtils_1.isValidDate(dateFromProp) && dateFromProp.toString() !== new Date(date).toString()) {
    ...
    const timestamp = (React.createElement("span", Object.assign({ className: react_styles_1.css(timestamp_1.default.timestamp, tooltip && timestamp_1.default.modifiers.helpText, className) }, (tooltip && { tabIndex: 0 }), propsWithoutDateTime),
