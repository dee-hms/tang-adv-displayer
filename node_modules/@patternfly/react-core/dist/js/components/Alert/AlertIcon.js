...
const AlertIcon = (_a) => {
    ...
    return Icon ? (React.createElement("div", Object.assign({}, props, { className: react_styles_1.css(alert_1.default.alertIcon, className) }), customIcon || React.createElement(Icon, null))) : null;
};
