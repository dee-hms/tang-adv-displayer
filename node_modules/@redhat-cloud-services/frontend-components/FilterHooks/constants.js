    ...
    return allTags.map(function (_a) {
        ...
        return (__assign(__assign({}, rest), { label: name, value: name, type: type, items: tags.map(function (_a) {
                ...
                return {
                    ...
                    label: ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_core_1.Tooltip, __assign({ content: tagText }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "ins-c-tagfilter__option-value" }, { children: tagText })) })), count !== undefined && ((0, jsx_runtime_1.jsx)(react_core_1.Tooltip, __assign({ position: "right", enableFlip: true, content: "Applicable to ".concat(count, " ").concat(item).concat(count === 1 ? '' : 's', ".") }, { children: (0, jsx_runtime_1.jsx)(react_core_1.Badge, __assign({ isRead: count <= 0 }, { children: count })) })))] })),
                    meta: {
                        count: count,
                        tag: {
                            key: tagKey,
