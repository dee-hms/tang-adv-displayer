...
class TimePicker extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (time !== '' && time !== prevProps.time) {
            const parsedTime = TimePickerUtils_1.parseTime(time, timeRegex, delimiter, !is24Hour, includeSeconds);
            this.setState({
    ...
    render() {
        ...
        removeFindDomNode, zIndex } = _a, props = tslib_1.__rest(_a, ['aria-label', "isDisabled", "className", "placeholder", "id", "menuAppendTo", "is24Hour", "invalidFormatErrorMessage", "invalidMinMaxErrorMessage", "stepMinutes", "width", "delimiter", "inputProps", "onChange", "setIsOpen", "isOpen", "time", "validateTime", "minTime", "maxTime", "includeSeconds", "removeFindDomNode", "zIndex"]);
        ...
        const textInput = (React.createElement(TextInput_1.TextInput, Object.assign({ "aria-haspopup": "menu", className: react_styles_1.css(form_control_1.default.formControl), id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", iconVariant: "clock", onClick: this.onInputClick, onChange: this.onInputChange, autoComplete: "off", isDisabled: isDisabled, ref: this.inputRef }, inputProps)));
                ...
                React.createElement(InputGroup_1.InputGroup, null,
                    React.createElement("div", { id: randomId },
                        React.createElement("div", { ref: this.toggleRef, style: { paddingLeft: '0' } },
                            React.createElement(Popper_1.Popper, { appendTo: calculatedAppendTo, trigger: textInput, popper: menuContainer, isVisible: isTimeOptionsOpen, removeFindDomNode: removeFindDomNode, zIndex: zIndex })))),
