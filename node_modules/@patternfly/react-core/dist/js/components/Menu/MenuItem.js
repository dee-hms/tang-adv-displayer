...
const MenuItemBase = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: react_styles_1.css(menu_1.default.menuListItem, isDisabled && menu_1.default.modifiers.disabled, _isOnPath && menu_1.default.modifiers.currentPath, isLoadButton && menu_1.default.modifiers.load, isLoading && menu_1.default.modifiers.loading, isFocused && menu_1.default.modifiers.focus, isDanger && menu_1.default.modifiers.danger, className), onMouseOver: onMouseOver }, (flyoutMenu && { onKeyDown: handleFlyout }), { ref: ref, role: !hasCheck ? 'none' : 'menuitem' }, props),
        React.createElement(GenerateId_1.GenerateId, null, randomId => (React.createElement(Component, Object.assign({ tabIndex: -1, className: react_styles_1.css(menu_1.default.menuItem, getIsSelected() && !hasCheck && menu_1.default.modifiers.selected, className), "aria-current": getAriaCurrent() }, (!hasCheck && { disabled: isDisabled }), (!hasCheck && !flyoutMenu && { role: 'menuitem' }), { ref: innerRef }, (!hasCheck && {
            onClick: (event) => {
