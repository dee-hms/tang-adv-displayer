...
const SelectBase = (_a) => {
    var { children, className, onSelect, isOpen, selected, toggle, onOpenChange, isPlain, minWidth, innerRef, zIndex = 9999 } = _a, props = tslib_1.__rest(_a, ["children", "className", "onSelect", "isOpen", "selected", "toggle", "onOpenChange", "isPlain", "minWidth", "innerRef", "zIndex"]);
    ...
    const menu = (react_1.default.createElement(Menu_1.Menu, Object.assign({ className: react_styles_1.css(className), ref: menuRef, onSelect: (event, itemId) => onSelect(event, itemId), isPlain: isPlain, selected: selected }, (minWidth && {
        style: {
            '--pf-c-menu--MinWidth': minWidth
        }
    }), helpers_1.getOUIAProps(exports.Select.displayName, props.ouiaId !== undefined ? props.ouiaId : helpers_1.getDefaultOUIAId(exports.Select.displayName), props.ouiaSafe !== undefined ? props.ouiaSafe : true), props),
