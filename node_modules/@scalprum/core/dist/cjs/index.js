...
exports.asyncLoader = exports.processManifest = exports.injectScript = exports.getAppData = exports.initialize = exports.preloadModule = exports.getPendingLoading = exports.setPendingLoading = exports.resolvePendingInjection = exports.getPendingInjection = exports.setPendingInjection = exports.getCachedModule = exports.getScalprum = exports.GLOBAL_NAMESPACE = void 0;
...
var setPendingInjection = function (id, injectionLock) {
    window[exports.GLOBAL_NAMESPACE].pendingInjections[id] = injectionLock;
};
exports.setPendingInjection = setPendingInjection;
var getPendingInjection = function (id) {
    return window[exports.GLOBAL_NAMESPACE].pendingInjections[id];
};
exports.getPendingInjection = getPendingInjection;
var resolvePendingInjection = function (id) {
    delete window[exports.GLOBAL_NAMESPACE].pendingInjections[id];
};
exports.resolvePendingInjection = resolvePendingInjection;
var setPendingLoading = function (scope, module, promise) {
    window[exports.GLOBAL_NAMESPACE].pendingLoading[scope + "#" + module] = promise;
    promise
        .then(function (data) {
        delete window[exports.GLOBAL_NAMESPACE].pendingLoading[scope + "#" + module];
        return data;
    })
        .catch(function () {
        delete window[exports.GLOBAL_NAMESPACE].pendingLoading[scope + "#" + module];
...
exports.setPendingLoading = setPendingLoading;
var getPendingLoading = function (scope, module) {
    return window[exports.GLOBAL_NAMESPACE].pendingLoading[scope + "#" + module];
};
exports.getPendingLoading = getPendingLoading;
var preloadModule = function (scope, module, processor, skipCache) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            manifestLocation = (0, exports.getAppData)(scope).manifestLocation;
            cachedModule = (0, exports.getCachedModule)(scope, module, skipCache);
            modulePromise = (0, exports.getPendingLoading)(scope, module);
            ...
            return [2, (0, exports.setPendingLoading)(scope, module, Promise.resolve(modulePromise))];
        });
    });
};
...
var initialize = function (_a) {
    ...
    window[exports.GLOBAL_NAMESPACE] = __assign({ appsConfig: appsConfig, pendingInjections: {}, pendingLoading: {}, factories: {}, scalprumOptions: defaultOptions }, api);
};
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    manifest = _a.sent();
                    pendingInjection = (0, exports.getPendingInjection)(scope);
                    if (pendingInjection) {
                    ...
                    injectionPromise = Promise.all(Object.entries(manifest)
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, (0, exports.injectScript)(appName, scriptLocation)];
                                case 1:
                                    data = _a.sent();
                                    (0, exports.resolvePendingInjection)(scope);
                                    return [2, data];
                            }
                        });
                    }); }));
                    (0, exports.setPendingInjection)(scope, injectionPromise);
