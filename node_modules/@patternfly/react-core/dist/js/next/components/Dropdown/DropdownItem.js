...
const DropdownItem = (_a) => {
    ...
    return (react_1.default.createElement(Menu_1.MenuItem, Object.assign({ className: react_styles_1.css(className), description: description, itemId: itemId }, ouiaProps, props), children));
};
