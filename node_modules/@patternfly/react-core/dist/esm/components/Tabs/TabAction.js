...
const TabActionBase = (_a) => {
    ...
    ouiaId, ouiaSafe } = _a, props = __rest(_a, ["children", "className", "onClick", "isHelpAction", "isDisabled", 'aria-label', "innerRef", "ouiaId", "ouiaSafe"]);
    return (React.createElement("span", { className: css(styles.tabsItemAction, isHelpAction && styles.modifiers.help, className) },
